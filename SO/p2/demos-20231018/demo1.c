...
void * mifuncion(void *arg) 
{
	...
	//exit(0);//si esto estuvira esto pararía el programa y liberaria memoria.
}
...
int main () 
{
    ...
    if( pthread_create(&tid, NULL, (void *) mifuncion, (void *) misargs) )//Casting a (void*) en cualquier puntero que pases en pthread_create.
    {                                                                     //misargs no necesita & porque ya es puntero.
