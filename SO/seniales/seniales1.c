...
int main()
{
  ...
  switch(pid) //En base al valor de pid cada proceso ejecutará una función
  {
    ...
    default:
      ...
      //El proceso se detiene para la sincronización de los procesos
      //No debe usarse
...
//Encolar señales por tipo y e orden de llegada
//Sig1 -> Sig2.1 -> Sig2.2 -> Sig1n 
/*
para ver las señales ejecutamos kill -l, sig1 = 10, sig2 = 12
el padre envía la uno y de seguido envía la 2 y luego viene otra vez del tipo 2
